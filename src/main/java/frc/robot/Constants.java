...
public final class Constants {
  ...
  public static final class IntakeConstants {
    ...
    public static final int kRedLed = 4;
    public static final int kGreenLed = 5;
  }
  ...
  public static final class PivotConstants {
    ...
    public static final int kGroundPoint = 275;
    public static final double kShootingPoint = 265;
    public static final int kStartPoint = 165;
    public static final int kAmpPoint = 165;
    public static final int kDrivePoint = 215;
    public static final int kIntakeHelper = 270;
  }
}
